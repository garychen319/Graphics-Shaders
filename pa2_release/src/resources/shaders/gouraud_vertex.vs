...
void main()
{
    ...
    totalLight += calcDirectionalLight(directionalLight, mvPos.xyz, mvVertexNormal);
    totalLight += calcPointLight(pointLight, mvPos.xyz, mvVertexNormal); 
    
    color = baseColour * totalLight;
}