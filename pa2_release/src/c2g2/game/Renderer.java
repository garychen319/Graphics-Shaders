...
public class Renderer {
  ...
  //Gouraud Shader
    ...
    //Checkerboard Shader
    public ShaderProgram createCheckShader() throws Exception {
        ShaderProgram shaderProgram = new ShaderProgram();

        shaderProgram.createVertexShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/check_vertex.vs"))));
        shaderProgram.createFragmentShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/check_fragment.fs"))));
        shaderProgram.link();
    ...
    public ShaderProgram createTestShader() throws Exception {
        ...
        shaderProgram.createVertexShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/z.vs"))));
        shaderProgram.createFragmentShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/z.fs"))));
        shaderProgram.link();
...
//Uncomment a shader to test it
    public void init(Window window) throws Exception {
        ...
        //shaderProgramList.put("check", createCheckShader());
    ...
    public void render(Window window, Camera camera, GameItem[] gameItems, Vector3f ambientLight,
        ...
        else if(currentShader.equals("check")) {
            shaderProgram.setUniform("projectionMatrix", projectionMatrix);
